...
This situation is an example of a *data race* ([§17.4.5](https://docs.oracle.com/javase/specs/jls/se17/html/jls-17.html#jls-17.4.5)). When code contains a data race, counterintuitive results are often possible.
