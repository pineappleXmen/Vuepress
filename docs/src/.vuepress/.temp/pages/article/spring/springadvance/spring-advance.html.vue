...
<Mermaid id="mermaid-373" code="eJxLL0osyFDwCeLietox++nuXQq6unYKT/bNfbF12rPNK562LuVC5oBln3bMfbq8+2nPNKAWKAsi3r/++ZQVXBAKLPJySsOz9Y1cAGvhNUI="></Mermaid><p>创建前后的增强</p>
<ul>
...
<Mermaid id="mermaid-1058" code="eJxLL0osyFDwCeLiSjXUSFV42jH76e5dmlypRkBOcWqJwrPNK562LlVI0+TiSjPUSIMrACrX1bVLAxGpRlxcAMg6GWw="></Mermaid><p>解决</p>
<ul>
<li>仍然使用 @Lazy 生成代理</li>
<li>代理对象虽然还是同一个，但当每次<strong>使用代理对象的任意方法</strong>时，由代理创建新的 f 对象</li>
</ul>
<Mermaid id="mermaid-1074" code="eJxLL0osyFDwCeLiSjXUSFV42jH76e5dmlypRkBOcWqJwrPNK562LlVIe7J78fMJbZpcXGmGGmlwZWlGyBxjJA7QOF1du1QjoEm6uk/27n8+ZUXas2k7n22eChROM8QujEO1MRcXALSiSpg="></Mermaid><div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Component</span>
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">E</span> <span class="token punctuation">{</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">A12</span> <span class="token punctuation">{</span>
...
<span class="token comment">// ⬇️这就是 jdk 代理类的源码, 秘密都在里面</span>
...
<Mermaid id="mermaid-1570" code="eJxLzkksLnbJTEwvSszl4gLzFBxTyjKTU6Ec39SSjPwUz7yS1KLk1IKS/CIkRcVwXkB+Zl5JcmkJTJQLJqBgU6Orq+BYXJCaXOLlWlFQlFpcnJmfB5PmgtgFUYVpFdQ4iDS6HWh8hXygGqUnOxqU4CrxKIH6kcvGBqgitSgtMTnVzg4miiqI6SxUebhtmGaBnIldMUwWAAImitk="></Mermaid><p>代理相关类图</p>
<ul>
...
<Mermaid id="mermaid-2314" code=""></Mermaid><ul>
...
<Mermaid id="mermaid-2350" code="eJxLzkksLnbJTEwvSszl4gooyi9ILSqpdE3JLMkvCkpNzywuKapUyNfVVVB6umSWkgKqAi4uG5vMvJLUorTE5FQ7OzRZmHa8irgAPOUwBA=="></Mermaid><ul>
...
<Mermaid id="mermaid-2371" code="eJx9j8EKwjAQRO/5iv5A/6AIahW8iQqel3QsC2lSN2uh4MdbFQ+taa8zb3ZmraMYS6ZaqDGXvsU2+A6ikKx45nl25qZ1GBkpbAPyV6G2hRyGQAopWWB1z3DV2lrEGJKXzpDOQU+4PxC1JKUN+2poNYkpWZ6vspFSwqEmhZksWiATwxbouX0LkfGbP/kT+KqRg3/fZYsF9ihheEb7XcUa5ISao0pvTFGwH9gbWawmEybef9vYn2l4AZSAyUs="></Mermaid><ul>
