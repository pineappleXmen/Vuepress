...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>public class Test01 {
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>//所以可以写成
public class Test01 {
    public static void main(String[] args) {
        Scanner sc = new Scanner(System.in);
        int num = sc.nextInt();
...
<p class="custom-container-title">2.给定一组0，-1，+1数组，分割点k左大于等于0、右侧小于等于0的为异常数据，求最乐观情况下有多少个异常数据</p>
</div>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>public class Test02 {
    public static void main(String[] args) {
        Scanner sc = new Scanner(System.in);
        int num = sc.nextInt();
...
<p class="custom-container-title">3.给定一组魔法石正面和反面表示的数字，只有当至少一半相同数字的面朝上可以触发法阵，初始状态为全部朝上，求最少需要翻转多少块石头可以触发法阵，无解输出-1</p>
</div>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>public class Test03 {
    public static void main(String[] args) {
        Scanner sc = new Scanner(System.in);
...
<p class="custom-container-title">4.给定n个样本的类别编号，输入的次序为样本编号，每类样本编号最小的(m+1)/2为训练集，剩下的为测试集。按照样本编号升序输出所有训练集样本及训练集样本</p>
</div>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>public class Test04 {
    public static void main(String[] args) {
        Scanner sc = new Scanner(System.in);
        int n = sc.nextInt();
        int k = sc.nextInt();
...
<p class="custom-container-title">5.将字符串s丢入机器后则输出新字符串s+reverse(s)+"wow"。初始字符串为"MeiTuan"，不停的反复将新字符串丢入机器，求得到的无限长字符串的第k位字母（1 ≤ k ≤ 1e18）</p>
</div>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>public class Test05 {
    public static void main(String[] args) {
        Scanner sc = new Scanner(System.in);
        int i = sc.nextInt();
