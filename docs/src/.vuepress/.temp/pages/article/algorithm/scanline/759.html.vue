<template><div><h4 id="_759-员工空闲时间" tabindex="-1"><a class="header-anchor" href="#_759-员工空闲时间" aria-hidden="true">#</a> <a href="https://leetcode.cn/problems/employee-free-time/" target="_blank" rel="noopener noreferrer">759. 员工空闲时间<ExternalLinkIcon/></a></h4>
<p>难度困难90</p>
<p>给定员工的 <code v-pre>schedule</code> 列表，表示每个员工的工作时间。</p>
<p>每个员工都有一个非重叠的时间段 <code v-pre>Intervals</code> 列表，这些时间段已经排好序。</p>
<p>返回表示 <em>所有</em> 员工的 <strong>共同，正数长度的空闲时间</strong> 的有限时间段的列表，同样需要排好序。</p>
<p><strong>示例 1：</strong></p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>输入：schedule = [[[1,2],[5,6]],[[1,3]],[[4,10]]]
输出：[[3,4]]
解释：
共有 3 个员工，并且所有共同的
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>输入：schedule = [[[1,3],[6,7]],[[2,4]],[[2,5],[9,12]]]
输出：[[5,6],[7,9]]
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>（尽管我们用 <code v-pre>[x, y]</code> 的形式表示 <code v-pre>Intervals</code> ，内部的对象是 <code v-pre>Intervals</code> 而不是列表或数组。例如，<code v-pre>schedule[0][0].start = 1, schedule[0][0].end = 2</code>，并且 <code v-pre>schedule[0][0][0]</code> 是未定义的）</p>
<p>而且，答案中不包含 [5, 5] ，因为长度为 0。</p>
<p><strong>注：</strong></p>
<ol>
<li><code v-pre>schedule</code> 和 <code v-pre>schedule[i]</code> 为长度范围在 <code v-pre>[1, 50]</code>的列表。</li>
<li><code v-pre>0 &lt;= schedule[i].start &lt; schedule[i].end &lt;= 10^8</code>。</li>
</ol>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// Definition for an Interval.</span>
