<template><div><h4 id="_426-将二叉搜索树转化为排序的双向链表" tabindex="-1"><a class="header-anchor" href="#_426-将二叉搜索树转化为排序的双向链表" aria-hidden="true">#</a> <a href="https://leetcode.cn/problems/convert-binary-search-tree-to-sorted-doubly-linked-list/" target="_blank" rel="noopener noreferrer">426. 将二叉搜索树转化为排序的双向链表<ExternalLinkIcon/></a></h4>
<p>难度中等187</p>
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>输入：root = [4,2,5,1,3] 
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>输入：root = [2,1,3]
输出：[1,2,3]
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>输入：root = []
输出：[]
解释：输入是空树，所以输出也是空链表。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>示例 4：</strong></p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>输入：root = [1]
输出：[1]
...
<ul>
<li><code v-pre>-1000 &lt;= Node.val &lt;= 1000</code></li>
<li><code v-pre>Node.left.val &lt; Node.val &lt; Node.right.val</code></li>
<li><code v-pre>Node.val</code> 的所有值都是独一无二的</li>
<li><code v-pre>0 &lt;= Number of Nodes &lt;= 2000</code></li>
</ul>
<p>通过次数12,109</p>
<p>提交次数17,777</p>
